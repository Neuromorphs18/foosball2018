...
tf.app.flags.DEFINE_integer('image_h', "90", """ image height """)
tf.app.flags.DEFINE_integer('image_w', "120", """ image width """)
...
def main(args):
    checkArgs()
    if FLAGS.testing:
        modelFoos.test(FLAGS)
    elif FLAGS.finetune:
        modelFoos.training(FLAGS, is_finetune=True)
    else:
        modelFoos.training(FLAGS, is_finetune=False)
