...
def training(FLAGS, is_finetune=False):
  ...
  with tf.Graph().as_default():
    ...
    train_data_node = tf.placeholder( tf.float32, shape=[batch_size, image_h, image_w, image_c], name='input')
    ...
    # eval_prediction = tf.placeholder( tf.float32, shape=[batch_size, image_h, image_w, 1], name='output')
    ...
    eval_prediction = tf.identity(eval_prediction, name="output")
