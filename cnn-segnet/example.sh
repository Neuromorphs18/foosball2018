...
# for training
python main.py --log_dir=./ --image_dir=../chainer-segnet/SegNet-Tutorial-master/CamVid/train.txt --val_dir=../chainer-segnet/SegNet-Tutorial-master/CamVid/val.txt --batch_size=5
