...
volatile unsigned int minimum_pulses = 0;
volatile unsigned int maximum_pulses = 980;
...
{
  byte buffer[6];
  unsigned int norm_pulses      = pulses - minimum_pulses;
  unsigned int norm_max_pulses  = maximum_pulses - minimum_pulses;
